...
jQuery(document).ready(function () {
    ...
    jQuery("img[src='']").attr("src", zoo_upload.url);

    jQuery('.zoo-opts-upload').click(function () {
        header_clicked = true;
    ...
    jQuery('.zoo-opts-upload-remove').click(function () {
        $relid = jQuery(this).attr('rel-id');
        jQuery('#' + $relid).val('');
        jQuery(this).prev().fadeIn('slow');
        jQuery(this).prev().prev().fadeOut('slow', function () { jQuery(this).attr("src", zoo_upload.url); });
